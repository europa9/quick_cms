...
/*- Get space and page ----------------------------------------------------------------------- */
if(isset($_SESSION['space_id']) && isset($_SESSION['page_id']) && isset($_SESSION['user_id']) && isset($_SESSION['security'])){

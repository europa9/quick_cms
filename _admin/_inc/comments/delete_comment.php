...
/**
*
* File: _admin/_inc/comments/delete_comment.php
* Version 1
...
if($get_current_comment_id == ""){
	...
	if($process == "1"){
		...
		$result = mysqli_query($link, "DELETE FROM $t_comments WHERE comment_id=$comment_id_mysql");

		$url = "index.php?open=$open&editor_language=$editor_language&ft=success&fm=comment_deleted";
		header("Location: $url");
		exit;
	}
	echo"
	...
	<p>
	<a href=\"index.php?open=$open&amp;page=$page&amp;comment_id=$comment_id&amp;editor_language=$editor_language&amp;process=1\" class=\"btn btn_warning\">Delete</a>
	</p>
	";
}
?>
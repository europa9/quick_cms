...
if($action == ""){
	...
	if($process == "1"){
		...
		VALUES 
		(NULL, $inp_title_mysql, $inp_description_mysql, $inp_contents_mysql, $inp_language_mysql, $inp_dir_name_mysql, $inp_category_id_mysql, $inp_intro_video_embedded_mysql, $inp_icon_a_mysql, $inp_icon_b_mysql, $inp_icon_c_mysql, 0, 0, 0, 0, 0, '$datetime', '$datetime')")

...
if(isset($_GET['q']) OR isset($_POST['q'])){
	...
	if($q != ""){
		...
		";
		$query = "SELECT location_id, location_number, location_title, location_title_clean, location_physical_district_id, location_physical_district_title, location_icon_path, location_icon_16, location_icon_32, location_icon_260, location_number_of_cases_now FROM $t_edb_physical_locations_index";
		$query = $query  . " WHERE location_title LIKE $q_mysql";
		$result = mysqli_query($link, $query);
		while($row = mysqli_fetch_row($result)) {
			list($get_location_id, $get_location_number, $get_location_title, $get_location_title_clean, $get_location_physical_district_id, $get_location_physical_district_title, $get_location_icon_path, $get_location_icon_16, $get_location_icon_32, $get_location_icon_260, $get_location_number_of_cases_now) = $row;
			...
			echo"
			 <tr>
			  <td class=\"$style\" style=\"width: 40%;\">
				<a id=\"#location$get_location_id\"></a>
				<span>
				<a href=\"index.php?open=edb&amp;page=physical_locations_index&amp;action=open_physical_location&amp;location_id=$get_location_id&amp;l=$l&amp;editor_language=$editor_language\">$get_location_title</a>
				</span>
			  </td>
			 </tr>";

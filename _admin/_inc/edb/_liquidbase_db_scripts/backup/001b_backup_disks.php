...
/**
*
* File: _admin/_inc/edb/_liquibase/backup/001b_backup_disks.php
* Version 1.0.0
...
$result = mysqli_query($link, "DROP TABLE IF EXISTS $t_edb_backup_disks") or die(mysqli_error($link)); 
...
if($result !== FALSE){
	...
	mysqli_query($link, "CREATE TABLE $t_edb_backup_disks(
	  ...
	  PRIMARY KEY(disk_id), 
	   ...
	   disk_created_datetime DATETIME,
	   disk_created_ddmmyyyy VARCHAR(500),
	   disk_updated_datetime DATETIME,
	   disk_updated_ddmmyyyy VARCHAR(500),
	   disk_client_machine_id INT,
	   disk_client_machine_name VARCHAR(500),
	   disk_client_machine_key VARCHAR(500),
	   disk_client_machine_ip VARCHAR(500),
	   disk_client_machine_agent VARCHAR(500),
	   disk_client_last_mounted_datetime DATETIME,
	   disk_client_last_mounted_ddmmyyyy VARCHAR(500),
	   disk_client_last_mounted_ddmmyyyyhhii VARCHAR(500),

...
elseif($mode == "flag"){
		...
		if(is_dir("_translations/admin/$language") && $language != ""){
			...
			<!-- Go back -->
				<p>
				<a href=\"index.php?open=settings&amp;page=cp_translation&amp;mode=open_language&amp;language=$language&amp;l=$l\"><img src=\"_design/gfx/icons/16x16/go-previous.png\" alt=\"go-previous.png\" /></a>
						...
						<table>
						 <tr>
						  <td style=\"padding: 2px 6px 0px 0px;\" >
							<a href=\"index.php?open=$open&amp;page=$page&amp;mode=open_directory&amp;folder=$get_admin_translation_directory_name&amp;language=$language&amp;editor_language=$editor_language\"><img src=\"_design/gfx/icons/16x16/folder.png\" alt=\"folder.png\" /></a>
						  </td>
						  <td>
...
elseif($mode == "open_directory"){
			...
			<!-- Select directory -->
					...
					while($row = mysqli_fetch_row($result)) {
						...
						<table>
						 <tr>
						  <td style=\"padding: 2px 6px 0px 0px;\" >
							<a href=\"index.php?open=$open&amp;page=$page&amp;mode=open_directory&amp;folder=$get_admin_translation_directory_name&amp;language=$language&amp;editor_language=$editor_language\"><img src=\"_design/gfx/icons/16x16/folder"; if($folder == "$get_admin_translation_directory_name"){ echo"-open"; } echo".png\" alt=\"folder.png\" /></a>
						  </td>
						  <td>
	...
	<!-- Content Right -->
		...
		<!-- Go back -->
			<div class=\"clear\"></div>
			<p>
			<a href=\"index.php?open=settings&amp;page=cp_translation\"><img src=\"_design/gfx/icons/16x16/go-previous.png\" alt=\"go-previous.png\" /></a>
					...
					if ($handle = opendir($dir)) {
						while (false !== ($content = readdir($handle))) {
							...
							if(isset($next_file)){
								...
								<a href=\"index.php?open=settings&amp;page=cp_translation&amp;mode=edit_language_file&amp;language=$language&amp;folder=$folder&amp;file=$content_saying&amp;l=$l\"><img src=\"_design/gfx/icons/16x16/go-next.png\" alt=\"go-next.png\" /></a>
								</p>
								";
								break;
							}

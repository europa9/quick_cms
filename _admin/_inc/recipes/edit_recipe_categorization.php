...
if($get_recipe_id == ""){
	...
	if($process == 1){
		...
		$result = mysqli_query($link, "UPDATE $t_recipes SET recipe_user_id=$inp_recipe_user_id_mysql, recipe_country=$inp_recipe_country_mysql, recipe_language=$inp_recipe_language_mysql, recipe_age_restriction=$inp_age_restriction_mysql WHERE recipe_id=$recipe_id_mysql");

		 ...
		 <tr>
		  ...
		  <td style=\"text-align: right;\">
			...
			for($x=0;$x<$active_languages_size;$x++){
				...
				$flag	 	= $temp[6];
				$charset	= $temp[7];
				echo"<option value=\"index.php?open=$open&amp;page=$page&amp;language=$iso_two\""; if($language == "$iso_two"){ echo" selected=\"selected\""; } echo">$name</option>\n";
			}
			echo"
			</select>
			</form>
				 ...
				 <tr>
				  <td class=\"outline\">
					...
					while($row = mysqli_fetch_row($result)) {
						list($get__id, $get_category_id, $get_category_name, $get_category_parent_id) = $row;
				
						echo"
						<a href=\"index.php?open=stram&amp;page=food&amp;action=open_main_category&amp;main_category_id=$get_category_id&amp;language=$language\">$get_category_name</a><br />
						";

...
<h1>Tables</h1>
	...
	<!-- discuss_topics -->
	";
	$query = "SELECT * FROM $t_discuss_topics";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_topics: $row_cnt</p>
		";
	}
	else{
		echo"
		...
		";
		mysqli_query($link, "CREATE TABLE $t_discuss_topics(
	...
	<!-- discuss_topics_subscribers -->
	";
	$query = "SELECT * FROM $t_discuss_topics_subscribers";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_topics_subscribers: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_topics_subscribers(
	...
	<!-- discuss_topics_read -->
	";
	$query = "SELECT * FROM $t_discuss_topics_read_by_user";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_topics_read_by_user: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_topics_read_by_user(
	...
	<!-- discuss_topics_read -->
	";
	$query = "SELECT * FROM $t_discuss_topics_read_by_ip";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_topics_read_by_ip: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_topics_read_by_ip(
	  	 topic_read_id INT NOT NULL AUTO_INCREMENT,
	 	  PRIMARY KEY(topic_read_id), 
	  	   topic_read_topic_id INT,
	...
	<!-- discuss_topics_tags -->
	";
	$query = "SELECT * FROM $t_discuss_topics_tags";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_topics_tags: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_topics_tags(
	...
	$query = "SELECT * FROM $t_discuss_replies";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_replies: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_replies(
	...
	<!-- discuss_replies_comments -->
	";
	$query = "SELECT * FROM $t_discuss_replies_comments";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_replies_comments: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_replies_comments(
	...
	$query = "SELECT * FROM $t_discuss_forms";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_forms: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_forms(
	...
	echo"
	<!-- //discuss_forms -->
	<!-- discuss_forms_questions -->
	";

	
	$query = "SELECT * FROM $t_discuss_forms_questions";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_forms_questions: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_forms_questions(
		...
		mysqli_query($link, "INSERT INTO $t_discuss_forms_questions
	...
	$query = "SELECT * FROM $t_discuss_titles";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_titles: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_titles(
		...
		mysqli_query($link, "INSERT INTO $t_discuss_titles
	...
	<!-- $t_discuss_top_users_monthly -->
	";

	
	$query = "SELECT * FROM $t_discuss_top_users_monthly";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_top_users_monthly: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_top_users_monthly(
	...
	<!-- $t_discuss_top_users_yearly -->
	";

	
	$query = "SELECT * FROM $t_discuss_top_users_yearly";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_top_users_yearly: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_top_users_yearly(
	...
	<!-- $t_discuss_top_users_all_time -->
	";

	
	$query = "SELECT * FROM $t_discuss_top_users_all_time";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_top_users_all_time: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_top_users_all_time(
	...
	<!-- $t_discuss_subscriptions -->
	";
	$query = "SELECT * FROM $t_discuss_subscriptions";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_subscriptions: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_subscriptions(
	  	 discuss_subscription_id INT NOT NULL AUTO_INCREMENT,
	 	  PRIMARY KEY(discuss_subscription_id), 
	  	   discuss_subscription_user_id VARCHAR(250),
	  	   discuss_subscription_user_email VARCHAR(250),
	  	   discuss_subscription_last_sendt_datetime DATETIME,
	  	   discuss_subscription_last_sendt_time VARCHAR(200))")
		   or die(mysqli_error());
		...
		while($row = mysqli_fetch_row($result)) {
			...
			mysqli_query($link, "INSERT INTO $t_discuss_subscriptions
	...
	<!-- tags_index -->
	";
	$query = "SELECT * FROM $t_discuss_tags_index";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_tags_index: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_tags_index(
	...
	";
	$query = "SELECT * FROM $t_discuss_tags_index_translation";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_tags_index_translation: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_tags_index_translation(
	...
	<!-- discuss_tags_watch -->
	";
	$query = "SELECT * FROM $t_discuss_tags_watch";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_tags_watch: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_tags_watch(
	...
	<!-- discuss_tags_ignore -->
	";
	$query = "SELECT * FROM $t_discuss_tags_ignore";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_discuss_tags_ignore: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_discuss_tags_ignore(

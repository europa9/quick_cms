...
if($action == ""){
	...
	if(file_exists("_data/logo.php")){
		...
		<form method=\"post\" action=\"index.php?open=$open&amp;page=$page&amp;action=upload&amp;editor_language=$editor_language&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
...
?>";
	...
	$url = "index.php?open=$open&page=$page&editor_language=$editor_language" . $ft . $fm;
	header("Location: $url");
	exit;

...
if($get_current_form_id == ""){
	...
	if($action == ""){
		...
		<p>
		<a href=\"index.php?open=contact_forms&amp;page=edit_contact_form_new_image_uploader&amp;form_id=$form_id&amp;editor_language=$editor_language\"><img src=\"_design/gfx/icons/16x16/image-x-generic.png\" alt=\"image-x-generic.png\" /></a>

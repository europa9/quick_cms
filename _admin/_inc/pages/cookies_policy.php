...
$query = "SELECT language_active_id, language_active_name, language_active_iso_two, language_active_flag, language_active_default FROM $t_languages_active WHERE language_active_iso_two=$editor_language_mysql";
$result = mysqli_query($link, $query);
$row = mysqli_fetch_row($result);
list($get_current_language_active_id, $get_current_language_active_name, $get_current_language_active_iso_two, $get_current_language_active_flag, $get_current_language_active_default) = $row;
...
$result = mysqli_query($link, $query);
$row = mysqli_fetch_row($result);
list($get_my_user_id, $get_my_user_email, $get_my_user_name, $get_my_user_alias, $get_my_user_password, $get_my_user_salt, $get_my_user_security, $get_my_user_language, $get_my_user_gender, $get_my_user_measurement, $get_my_user_dob, $get_my_user_date_format, $get_my_user_registered, $get_my_user_last_online, $get_my_user_rank, $get_my_user_points, $get_my_user_likes, $get_my_user_dislikes, $get_my_user_status, $get_my_user_login_tries, $get_my_user_last_ip, $get_my_user_synchronized, $get_my_user_verified_by_moderator) = $row;

// Get my Profile
$query = "SELECT profile_id, profile_user_id, profile_first_name, profile_middle_name, profile_last_name, profile_address_line_a, profile_address_line_b, profile_zip, profile_city, profile_country, profile_phone, profile_work, profile_university, profile_high_school, profile_languages, profile_website, profile_interested_in, profile_relationship, profile_about, profile_newsletter FROM $t_users_profile WHERE profile_user_id=$my_user_id_mysql";
$result = mysqli_query($link, $query);
$row = mysqli_fetch_row($result);
...
if($get_current_cookies_policy_id == ""){
	...
	$inp_my_name_mysql = quote_smart($link, "$get_my_profile_first_name $get_my_profile_middle_name $get_my_profile_last_name");
...
if($process == "1"){
	...
	$inp_my_user_name_mysql = quote_smart($link, $get_my_user_name);
	$inp_my_user_email_mysql = quote_smart($link, $get_my_user_email);
	$inp_my_name = "$get_my_profile_first_name $get_my_profile_middle_name $get_my_profile_last_name";
	$inp_my_name_mysql = quote_smart($link, "$get_my_profile_first_name $get_my_profile_middle_name $get_my_profile_last_name");

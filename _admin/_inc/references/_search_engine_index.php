...
if($result_exists !== FALSE){
	...
	while($row_w = mysqli_fetch_row($result_w)) {
		...
		$inp_index_reference_id_mysql = quote_smart($link, "reference_id$get_reference_id");
		...
		while($row_g = mysqli_fetch_row($result_g)) {
			...
			$inp_index_reference_id_mysql = quote_smart($link, "group_id$get_group_id");
			...
			while($row_guides = mysqli_fetch_row($result_guides)) {
				...
				$inp_index_reference_id_mysql = quote_smart($link, "guide_id$get_guide_id");

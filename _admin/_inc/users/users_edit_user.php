...
if($action == "photos"){
			...
			<!-- Menu -->
				<div class=\"tabs\">
					<ul>
						<li"; if($action == ""){ echo" id=\"current\" "; } echo"><a href=\"index.php?open=$open&amp;page=users_edit_user&amp;user_id=$user_id&amp;l=$l&amp;refer=$refer&amp;editor_language=$editor_language\">$l_edit_user</a></li>
						<li"; if($action == "edit_profile"){ echo" id=\"current\" "; } echo"><a href=\"index.php?open=$open&amp;page=users_edit_user&amp;action=edit_profile&amp;user_id=$user_id&amp;l=$l&amp;refer=$refer&amp;editor_language=$editor_language\">$l_edit_profile</a></li>
						<li"; if($action == "edit_password"){ echo" id=\"current\" "; } echo"><a href=\"index.php?open=$open&amp;page=users_edit_user&amp;action=edit_password&amp;user_id=$user_id&amp;l=$l&amp;refer=$refer&amp;editor_language=$editor_language\">$l_password</a></li>
						<li"; if($action == "photos"){ echo" id=\"current\" "; } echo"><a href=\"index.php?open=$open&amp;page=users_edit_user&amp;action=photos&amp;user_id=$user_id&amp;l=$l&amp;refer=$refer&amp;editor_language=$editor_language\">$l_photos</a></li>
					</ul>
				</div>
				<div class=\"clear\"></div>
			<!-- //Menu -->
			...
			<!-- Display photos -->
				...
				while($row = mysqli_fetch_row($result)) {
					...
					<div class=\"right\">
						...
						<a href=\"index.php?open=$open&amp;page=users_edit_user&amp;action=photos&amp;mode=delete_photo&amp;photo_id=$get_photo_id&amp;user_id=$user_id&amp;l=$l#photo$prev_photo_id\">$l_delete_this_photo</a>
						</p>
					</div>
					<div class=\"clear\"></div>
					";
...
elseif($action == "edit_password"){
			...
			<form method=\"POST\" action=\"index.php?open=$open&amp;page=users_edit_user&amp;action=edit_password&amp;mode=save&amp;user_id=$user_id&amp;l=$l&amp;editor_language=$editor_language\" enctype=\"multipart/form-data\" name=\"nameform\">
...
elseif($action == "edit_profile"){
			...
			<form method=\"POST\" action=\"index.php?open=$open&amp;page=users_edit_user&amp;action=edit_profile&amp;mode=save&amp;user_id=$user_id&amp;l=$l&amp;editor_language=$editor_language\" enctype=\"multipart/form-data\" name=\"nameform\">
			...
			for ($i = 0; $i < count($filenames); $i++){
				...
				if($file_path != "_design/gfx/flags/16x16/.." && $file_path != "_design/gfx/flags/16x16/."){
					$country = "$content";

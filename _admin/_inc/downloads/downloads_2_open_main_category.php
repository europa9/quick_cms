	...
	if($get_current_main_category_id == ""){
		...
		<!-- Downloads without sub category -->
			...
			<table>
				";
				// Get all downloads
				$query = "SELECT download_id, download_title, download_introduction, download_image_path, download_image_store FROM $t_downloads_index WHERE download_main_category_id=$get_current_main_category_id ORDER BY download_title ASC";
				$result = mysqli_query($link, $query);
				while($row = mysqli_fetch_row($result)) {

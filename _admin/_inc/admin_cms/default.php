...
elseif($action == "my_navigation"){
	...
	<p>
	<a href=\"index.php?open=$open&amp;page=$page&amp;action=add_item&amp;editor_language=$editor_language&amp;l=$l\"><img src=\"_design/gfx/icons/16x16/add.png\" alt=\"add.png\" /> Add item</a>
	</p>
		...
		while($row = mysqli_fetch_row($result)) {
			...
			echo"
			 <tr>
			  ...
			  <td class=\"$style\">
				<span>
				<a href=\"index.php?open=$open&amp;page=$page&amp;action=move_up&amp;navigation_id=$get_navigation_id&amp;editor_language=$editor_language&amp;l=$l&amp;process=1\"><img src=\"_design/gfx/icons/16x16/go-up.png\" alt=\"go-up.png\" /></a> &nbsp;
				<a href=\"index.php?open=$open&amp;page=$page&amp;action=move_down&amp;navigation_id=$get_navigation_id&amp;editor_language=$editor_language&amp;l=$l&amp;process=1\"><img src=\"_design/gfx/icons/16x16/go-down.png\" alt=\"go-down.png\" /></a>  &nbsp;
				<a href=\"index.php?open=$open&amp;page=$page&amp;action=edit&amp;navigation_id=$get_navigation_id&amp;editor_language=$editor_language&amp;l=$l\"><img src=\"_design/gfx/icons/16x16/edit.png\" alt=\"edit.png\" /></a>  &nbsp;
				<a href=\"index.php?open=$open&amp;page=$page&amp;action=delete&amp;navigation_id=$get_navigation_id&amp;editor_language=$editor_language&amp;l=$l\"><img src=\"_design/gfx/icons/16x16/close_small_normal_hover.png\" alt=\"close_small_normal_hover.png\" /></a>
				</span>
			  </td>
			 </tr>
			";

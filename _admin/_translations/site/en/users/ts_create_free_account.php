...
// Register
$l_menu_create_free_account = "Create free account";
$l_email_address = "Email address";
$l_users_about_registration = "Registration is free and everyone can become a member. Please enter your data in the form below and you will be able to use this sites member functionality.";
$l_users_registration_form = "Registration form";
$l_users_antispam_about = "This is to prevent spam.";
...
$l_users_you_answered_wrong_on_antispam_question = "You answered wrong on the antispam question.";
$l_users_please_enter_a_alias = "Please enter a alias.";
$l_users_please_enter_your_email_address = "Please enter your e-mail address.";

$l_users_alias_taken = "The alias is already in use by another user. Please select another one.";
$l_users_email_taken = "The email address is already in use. Did you forgot your password?";

$l_users_please_enter_a_password = "Please enter a password";

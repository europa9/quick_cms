...
if($result !== FALSE){		
	...
	mysqli_query($link, "CREATE TABLE $t_users(
	   ...
	   user_verified_by_moderator VARCHAR(70),
...
$query = "SELECT * FROM $t_users_profile LIMIT 1";
$result = mysqli_query($link, $query);
if($result !== FALSE){
}
else{
	mysqli_query($link, "CREATE TABLE $t_users_profile(
	 profile_id INT NOT NULL AUTO_INCREMENT,
	 PRIMARY KEY(profile_id), 
	 profile_user_id INT,
	 profile_first_name VARCHAR(70),
	 profile_middle_name VARCHAR(70),
	 profile_last_name VARCHAR(70),
	 profile_address_line_a VARCHAR(70),
	 profile_address_line_b VARCHAR(70),
	 profile_zip VARCHAR(70),
	 profile_city VARCHAR(70),
	 profile_country VARCHAR(70),
	 profile_phone VARCHAR(70),
	 profile_work VARCHAR(70),
	 profile_university VARCHAR(70),
	 profile_high_school VARCHAR(70),
	 profile_languages VARCHAR(70),
	 profile_website VARCHAR(70),
	 profile_interested_in VARCHAR(70),
	 profile_relationship VARCHAR(70),
	 profile_about TEXT,
	 profile_newsletter INT,
	 profile_views INT,
	 profile_views_ip_block TEXT,
	 profile_privacy VARCHAR(20))")
	 or die(mysqli_error($link));
}

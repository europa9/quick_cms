...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_current_case_id != "" && $get_current_mirror_file_id != ""){
		...
		// Get Item ID
		$query = "SELECT mirror_file_item_id FROM $t_edb_case_index_evidence_items_mirror_files WHERE mirror_file_id=$get_current_mirror_file_id";
		$result = mysqli_query($link, $query);
		$row = mysqli_fetch_row($result);
		list($get_mirror_file_item_id) = $row;

		$query = "SELECT * FROM $t_edb_case_index_evidence_items WHERE item_id=$get_mirror_file_item_id AND item_case_id=$get_current_case_id";
		$result = mysqli_query($link, $query);
		$row = mysqli_fetch_array($result, MYSQLI_ASSOC);

			 ...
			 <thead>
			  <tr>
			   <th scope=\"col\">
				...
				if($get_my_station_member_rank == "admin" OR $get_my_station_member_rank == "moderator" OR $get_my_station_member_rank == "editor"){
					echo"
					<span><input type=\"checkbox\" name=\"inp_checkbox_check_all_checkboxes\" id=\"inp_checkbox_check_all_checkboxes\" /></span>
					<!-- Check all checkboxes -->
					<script>
					\$(function() {
						\$('#inp_checkbox_check_all_checkboxes').click(function() {

...
/**
*
* File: edb/open_case_unassign.php
* Version 1.0
		...
		if($get_my_station_member_id == ""){
			...
			if($process == "1"){
				$result = mysqli_query($link, "UPDATE $t_edb_case_index SET 
						case_assigned_to_datetime=NULL,
						case_assigned_to_time=NULL,
						case_assigned_to_date_saying=NULL,
						case_assigned_to_date_ddmmyy=NULL,
						case_assigned_to_user_id=NULL,
						case_assigned_to_user_name=NULL,
						case_assigned_to_user_alias=NULL,
						case_assigned_to_user_email=NULL,
						case_assigned_to_user_image_path=NULL,
						case_assigned_to_user_image_file=NULL,
						case_assigned_to_user_image_thumb_40=NULL,
						case_assigned_to_user_image_thumb_50=NULL,
						case_assigned_to_user_first_name=NULL,
						case_assigned_to_user_middle_name=NULL,
						case_assigned_to_user_last_name=NULL
						 WHERE case_id=$get_current_case_id") or die(mysqli_error($link));

				$hour_minute = date("H:i");
				$url = "open_case_overview.php?case_id=$get_current_case_id&l=$l&ft=success&fm=case_unassigned_at_" . $hour_minute;
				header("Location: $url");
				exit;
			}
		} // access to station

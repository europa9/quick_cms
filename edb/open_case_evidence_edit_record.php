	...
	if($get_current_case_id == ""){
		...
		if($get_my_station_member_id == ""){
			...
			if($process != "1"){
				...
				<!-- Where am I? -->
					...
					&gt;
					<a href=\"open_case_evidence_edit_record.php?case_id=$get_current_case_id&amp;record_id=$get_current_record_id&amp;l=$l\">$l_edit</a>
		...
		if($get_current_record_id == ""){
			...
			if($process == "1"){
				...
				$result = mysqli_query($link, "UPDATE $t_edb_case_index_evidence_records SET
								record_seized_year=$inp_seized_year_mysql, 
								record_seized_journal=$inp_seized_journal_mysql, 
								record_seized_district_id=$inp_seized_district_id_mysql, 
								record_seized_district_number=$inp_seized_district_number_mysql, 
								record_seized_district_title=$inp_seized_district_title_mysql
				...
				$result = mysqli_query($link, "UPDATE $t_edb_case_index_evidence_items SET
								item_record_seized_year=$inp_seized_year_mysql, 
								item_record_seized_journal=$inp_seized_journal_mysql, 
								item_record_seized_district_number=$inp_seized_district_number_mysql
								WHERE item_record_id=$get_current_record_id") or die(mysqli_error($link));
			...
			echo"
			<h2>$l_edit $get_current_record_seized_year/$get_current_record_seized_journal-$get_current_record_seized_district_number</h2>
			...
			<!-- Edit evidence record -->
				<form method=\"POST\" action=\"open_case_evidence_edit_record.php?case_id=$get_current_case_id&amp;record_id=$get_current_record_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">

				<table>
				 <tr>
				  <td style=\"padding-right: 4px;text-align:center;\">
					<p><b>$l_year</b><br />
					<input type=\"text\" name=\"inp_seized_year\" value=\"$get_current_record_seized_year\" size=\"4\" tabindex=\""; $tabindex = $tabindex+1; echo"$tabindex\" style=\"text-align:center;border: #fff 1px solid;border-bottom: #ccc 1px dashed;\" />
					</p>
				  </td>
				  ...
				  <td style=\"padding-right: 4px;text-align:center;\">
					<p><b>$l_journal</b><br />
					<input type=\"text\" name=\"inp_seized_journal\" value=\"$get_current_record_seized_journal\" size=\"6\" tabindex=\""; $tabindex = $tabindex+1; echo"$tabindex\" style=\"text-align:center;border: #fff 1px solid;border-bottom: #ccc 1px dashed;\" />
					</p>
				  </td>
				  <td style=\"padding-right: 4px;text-align:center;vertical-align:top;\">
					<p><b>-</b></p>
				  ...
				  <td style=\"padding-right: 4px;text-align:center;\">
					<p><b>$l_district</b><br />
					<input type=\"text\" name=\"inp_seized_district_number\" value=\"$get_current_record_seized_district_number\" size=\"6\" tabindex=\""; $tabindex = $tabindex+1; echo"$tabindex\" style=\"text-align:center;border: #fff 1px solid;border-bottom: #ccc 1px dashed;\" />
					</p>
				  </td>
				 </tr>
				</table>

...
if($get_current_main_muscle_group_id == "" OR $get_current_sub_muscle_group_id == ""){
	/*- Headers ---------------------------------------------------------------------------------- */
	$website_title = "$l_muscles - Server error 404";
	if(file_exists("./favicon.ico")){ $root = "."; }
	elseif(file_exists("../favicon.ico")){ $root = ".."; }
	elseif(file_exists("../../favicon.ico")){ $root = "../.."; }
	elseif(file_exists("../../../favicon.ico")){ $root = "../../.."; }
	...
	/*- Headers ---------------------------------------------------------------------------------- */
	$website_title = "$l_muscles - $get_current_main_muscle_group_translation_name - $get_current_sub_muscle_group_translation_name";
	if(file_exists("./favicon.ico")){ $root = "."; }
	elseif(file_exists("../favicon.ico")){ $root = ".."; }
	elseif(file_exists("../../favicon.ico")){ $root = "../.."; }
	elseif(file_exists("../../../favicon.ico")){ $root = "../../.."; }
	...
	<!-- Add a comment -->";
		...
		$object_id      = "$get_current_sub_muscle_group_id";
		$object_user_id = "1";
		$refer          = "../muscles/open_sub_group.php?main_group_id=$get_current_main_muscle_group_id&amp;sub_group_id=$get_current_sub_muscle_group_id";

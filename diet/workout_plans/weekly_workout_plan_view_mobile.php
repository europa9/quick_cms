...
if($get_current_workout_weekly_id == ""){
	...
	/*- Headers ---------------------------------------------------------------------------------- */
	$website_title = "$l_workout_plans - $get_current_workout_weekly_title ($l_mobile)";
	if(file_exists("./favicon.ico")){ $root = "."; }
	elseif(file_exists("../favicon.ico")){ $root = ".."; }
	elseif(file_exists("../../favicon.ico")){ $root = "../.."; }
	elseif(file_exists("../../../favicon.ico")){ $root = "../../.."; }
	...
	<!-- Add a comment -->";
		...
		$refer          = "../workout_plans/weekly_workout_plan_view.php?weekly_id=$get_current_workout_weekly_id";

...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_current_workout_weekly_id == ""){
		...
		<!-- Where am I ? -->
			...
			&gt;
			<a href=\"weekly_workout_plan_edit_sessions.php?weekly_id=$weekly_id&amp;duration_type=$duration_type&amp;l=$l\">$l_edit</a>
			</p>
		<!-- //Where am I ? -->
		...
		<!-- Form -->
			...
			<p><b>$l_goal:</b><br />
			<textarea name=\"inp_goal\" rows=\"10\" cols=\"70\" class=\"myTextEditor\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\">$get_current_workout_weekly_goal</textarea>
			</p>

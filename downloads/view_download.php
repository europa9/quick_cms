...
if($get_current_download_id == ""){
	...
	if($get_current_main_category_id == ""){
		...
		if($get_current_download_sub_category_id == "0"){
			$website_title = "$l_downloads - $get_current_main_category_translation_value - $get_current_download_title";
		}
		else{
			// Sub category
			...
			if($get_current_sub_category_id == ""){
				$website_title = "$l_downloads - Server error 404";
			}
			else{
				// Find translation
			...
			<div id=\"download_images\">
				...
				\$(document).ready(function(){
					\$('#thumbs img').click(function(){
						\$('#largeImage').attr('src','$root/$get_current_download_image_path/' + \$(this).attr('alt'));
				...
				if(file_exists("$root/$get_current_download_image_path/$get_current_download_image_file_a") && $get_current_download_image_file_a != ""){
					echo"
					<h2>$l_images</h2>
					<img id=\"largeImage\" src=\"$root/$get_current_download_image_path/$get_current_download_image_file_a\" alt=\"$get_current_download_image_file_a\" />
					";
				}
				echo"
				<div id=\"thumbs\">
				";
					if(file_exists("$root/$get_current_download_image_path/$get_current_download_image_thumb_a") && $get_current_download_image_thumb_a != ""){
						echo"<img src=\"$root/$get_current_download_image_path/$get_current_download_image_thumb_a\" alt=\"$get_current_download_image_file_a\" />\n";
					}
					if(file_exists("$root/$get_current_download_image_path/$get_current_download_image_thumb_b") && $get_current_download_image_thumb_b != ""){
						echo"<img src=\"$root/$get_current_download_image_path/$get_current_download_image_thumb_b\" alt=\"$get_current_download_image_file_b\" />\n";
					}
					if(file_exists("$root/$get_current_download_image_path/$get_current_download_image_thumb_c") && $get_current_download_image_thumb_c != ""){
						echo"<img src=\"$root/$get_current_download_image_path/$get_current_download_image_thumb_c\" alt=\"$get_current_download_image_file_c\" />\n";
					}
					if(file_exists("$root/$get_current_download_image_path/$get_current_download_image_thumb_d") && $get_current_download_image_thumb_d != ""){
						echo"<img src=\"$root/$get_current_download_image_path/$get_current_download_image_thumb_d\" alt=\"$get_current_download_image_file_d\" />\n";
					}
					echo"
				</div>
			</div>

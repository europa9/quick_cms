...
food_sodium_calculated='$inp_food_sodium_calculated' WHERE food_id='$get_food_id'") or print(mysqli_error());
		...
		<!-- General information -->
			...
			<!-- //Food image -->
			<p>
			<a href=\"new_food_7_numbers_hundred.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$l_enter_per_hundred</a>
			&middot;
			<a href=\"new_food_7_numbers_pcs.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\">$l_enter_per_pcs</a>
			</p>

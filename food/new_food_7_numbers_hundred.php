...
food_sodium_calculated='$inp_food_sodium_calculated' WHERE food_id='$get_food_id'") or print(mysqli_error());
		...
		<!-- General information -->
			...
			<p>
			$l_enter_per:
			<a href=\"new_food_7_numbers_hundred.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">100 $get_food_net_content_metric_measurement</a>
			&middot;
			<a href=\"new_food_7_numbers_pcs.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\">$get_food_serving_size_pcs $get_food_serving_size_pcs_measurement</a>
			</p>

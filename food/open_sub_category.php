		...
		while($row = mysqli_fetch_row($result)) {
			...
			if(file_exists("$root/$get_food_image_path/$get_food_image_a") && $get_food_image_a != "" && $show_food ==  "true"){
				...
				if($update_statistics == 1){
					...
					if($get_food_carbohydrates_of_which_dietary_fiber < $inp_current_sub_category_carb_of_which_dietary_fiber_min && $get_food_carbohydrates_of_which_dietary_fiber != 0){
						$inp_current_sub_category_carb_of_which_dietary_fiber_min = $get_food_carbohydrates_of_which_dietary_fiber;
					}
					...
					$inp_current_sub_category_carb_of_which_dietary_fiber_med_sum = $inp_current_sub_category_carb_of_which_dietary_fiber_med_sum + $get_food_carbohydrates_of_which_dietary_fiber;
					...
					if($get_food_carbohydrates_of_which_dietary_fiber > $inp_current_sub_category_carb_of_which_dietary_fiber_max){
						$inp_current_sub_category_carb_of_which_dietary_fiber_max = $get_food_carbohydrates_of_which_dietary_fiber;
					}

...
/**
*
* File: food/new_food_7_images_resize.php
* Version 1.0.0
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_food_id == ""){
		...
		if($process != "1"){
			...
			echo"	<!-- Site CSS-->\n";
			echo"	<link rel=\"stylesheet\" type=\"text/css\" href=\"$root/food/_css/new_food_7_images_resize.css\" />\n";
			echo"	<!-- //Site CSS -->\n";
			...
			echo"	<body>\n";
			echo"	<a id=\"top\"></a>\n";
			echo"	<div id=\"wrapper\" style=\"background: url('_login_design/images/bg/19.jpg') no-repeat center center fixed;background-size: cover;\">
	<div id=\"content\">
	...
	<div id=\"main\">
		...
		<!-- Load image -->
			...
			if(file_exists("$image_path")){
				...
				<p>
				<a href=\"new_food_8_images_resize_rotate.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;image_number=$image_number&amp;l=$l&amp;process=1\" class=\"btn\">$l_rotate</a>
				&middot;
				";
				if($image_number == "a" OR $image_number == ""){
					echo"
					<a href=\"new_food_6_images.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;image_number=b&amp;l=$l\" class=\"btn btn_default\">$l_upload_food_table_image</a>
					&middot;";
				}
				elseif($image_number == "b"){
					echo"
					<a href=\"new_food_6_images.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;image_number=c&amp;l=$l\" class=\"btn btn_default\">$l_upload_other_image</a>
					&middot;";
				}
				elseif($image_number == "c"){
					echo"
					<a href=\"new_food_6_images.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;image_number=d&amp;l=$l\" class=\"btn btn_default\">$l_upload_inspiration_image</a>
					&middot;";
				}
				elseif($image_number == "d"){
					echo"
				...
				<a href=\"new_food_9_tags.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\" class=\"btn btn_default\">$l_tags</a>
				&middot; <a href=\"new_food_10_stores.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\" class=\"btn btn_default\">$l_stores</a>
				&middot; <a href=\"view_food.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\" class=\"btn btn_default\">$l_view_food</a>
				</p>
	...
	<footer>
		<p>
		<a href=\"https://codingfora.com\">&copy; 2019 Coding Fora</a>
		</p>
	</footer>
	<!-- //Footer -->

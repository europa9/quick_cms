...
/**
*
* File: food/new_food_7_numbers_pcs_us.php
* Version 1.0.0
* Date 15:54 07.03.2021
		...
		<!-- General information -->
			...
			<!-- Headline and system -->
				<table>
				 <tr>
				  ...
				  <td>
					<span>
					<a href=\"new_food_7_numbers_hundred_metric.php?food_id=$food_id&amp;l=$l\">$l_metric</a>
					&middot;
					<a href=\"new_food_7_numbers_pcs_us.php?food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$l_us</a>
					</span>
				  </td>
				 </tr>
				</table>
			...
			<!-- Numbers -->
				<div style=\"float: left;margin-right: 20px;\">
					...
					<form method=\"post\" action=\"new_food_7_numbers_pcs_us.php?main_category_id=$get_current_food_main_category_id&amp;sub_category_id=$get_current_food_sub_category_id&amp;food_id=$get_current_food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">

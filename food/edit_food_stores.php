...
include("$root/_admin/_translations/site/$l/food/ts_new_food_8_stores.php");
		...
		if($get_food_user_id != "$my_user_id"){
			...
			if($action == ""){
				if($process == "1"){
					...
					$url = "edit_food_stores.php?food_id=$get_food_id&l=$l&ft=success&fm=changes_saved";
					header("Location: $url");
					exit;
				}
				 ...
				 <tr>
				  <td style=\"vertical-align: top;padding-right: 20px;\">
					...
					while($row = mysqli_fetch_row($result)) {
						...
						if($get_food_store_id == ""){
							echo"
							<a href=\"edit_food_stores.php?food_id=$get_food_id&amp;store_id=$get_store_id&amp;l=$l&amp;process=1\">$get_store_name</a><br />
							";
						}
					}
				  ...
				  <td style=\"vertical-align: top;\">
					...
					while($row = mysqli_fetch_row($result)) {
						...
						echo"
						<a href=\"edit_food_stores.php?action=remove_food_store&amp;food_id=$get_food_id&amp;food_store_id=$get_food_store_id&amp;l=$l&amp;process=1\">$get_food_store_store_name</a><br />
						";
					}

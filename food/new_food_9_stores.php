				 ...
				 <tr>
				  <td style=\"vertical-align: top;padding-right: 20px;\">
					...
					while($row = mysqli_fetch_row($result)) {
						...
						if($get_current_food_store_id == ""){
							echo"
							<a href=\"new_food_9_stores.php?food_id=$get_current_food_id&amp;store_id=$get_store_id&amp;l=$l&amp;process=1\">$get_store_name</a><br />
							";
						}
					}
				  ...
				  <td style=\"vertical-align: top;\">
					...
					while($row = mysqli_fetch_row($result)) {
						...
						echo"
						<a href=\"new_food_9_stores.php?action=remove_food_store&amp;food_id=$get_current_food_id&amp;food_store_id=$get_current_food_store_id&amp;l=$l&amp;process=1\">$get_current_food_store_store_name</a><br />
						";
					}

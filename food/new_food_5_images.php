						...
						if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) {
							...
							if (move_uploaded_file($_FILES['inp_image']['tmp_name'], $uploaded_file)) {
								...
								if($width == "" OR $height == ""){
									...
									elseif($image == "e"){
										$result = mysqli_query($link, "UPDATE $t_food_index SET food_image_path=$inp_food_image_path_mysql, food_image_e=$inp_food_image_mysql, food_thumb_e_small='', food_thumb_e_medium='', food_thumb_e_large='' WHERE food_id='$get_current_food_id'");
									}

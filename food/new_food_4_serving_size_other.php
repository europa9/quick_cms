...
WHERE food_id='$get_food_id'") or die(mysqli_error($link));
				...
				$url = "new_food_5_numbers_other.php?main_category_id=$main_category_id&sub_category_id=$sub_category_id&food_id=$get_food_id&el=$l";
				header("Location: $url");
				exit;
			}
			else{
				$url = "new_food_4_serving_size_other.php?main_category_id=$main_category_id&sub_category_id=$sub_category_id&food_id=$get_food_id&l=$l";
				$url = $url . "&ft=$ft&fm=$fm";
		...
		<h1>$get_food_name - $get_food_country</h1>
			...
			<form method=\"post\" action=\"new_food_4_serving_size_other.php?food_id=$food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">

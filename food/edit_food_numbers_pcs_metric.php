...
/**
*
* File: food/edit_food_numbers_pcs_metric.php
* Version 1.0.0
* Date 16:51 16.04.2021
	...
	if(isset($_SESSION['user_id'])){
		...
		if($get_current_food_user_id != "$my_user_id"){
			...
			if($process == 1){
				...
				$url = "edit_food_numbers_pcs_metric.php?food_id=$get_current_food_id&l_$l&ft=success&fm=changes_saved";
				header("Location: $url");
				exit;
			...
			<!-- Where am I? -->
				...
				&gt;
				<a href=\"edit_food_numbers_pcs_metric.php?food_id=$food_id&amp;l=$l\">$l_numbers</a>
				</p>
			<!-- //Where am I? -->
			...
			<!-- Numbers -->
				<div style=\"float: left;margin-right: 20px;\">
					<form method=\"post\" action=\"edit_food_numbers_pcs_metric.php?food_id=$get_current_food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
					

					<!-- Measurement -->
						<p>
						$l_measurement:
						<a href=\"edit_food_numbers_hundred_metric.php?food_id=$food_id&amp;l=$l\">$l_per_hundred</a>
						&middot;
						<a href=\"edit_food_numbers_pcs_metric.php?food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$get_current_food_serving_size_pcs $get_current_food_serving_size_pcs_measurement</a>
						</p>
					<!-- //Measurement -->

				...
				if($ft == ""){
					...
					if($inp_food_serving_size_metric != "$get_food_serving_size_metric"){
						if($get_food_energy_metric != ""){
							$inp_food_energy_calculated_metric = round($get_food_energy_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_energy_calculated_metric = $get_food_energy_calculated_metric;
						}

						if($get_food_fat_metric != ""){
							$inp_food_fat_calculated_metric = round($get_food_fat_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_fat_calculated_metric = $get_food_fat_calculated_metric;
						}

						if($get_food_fat_of_which_saturated_fatty_acids_metric != ""){
							$inp_food_fat_of_which_saturated_fatty_acids_calculated_metric = round($get_food_fat_of_which_saturated_fatty_acids_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_fat_of_which_saturated_fatty_acids_calculated_metric = $get_food_fat_of_which_saturated_fatty_acids_calculated_metric;
						}

						if($get_food_carbohydrates_metric != ""){
							$inp_food_carbohydrates_calculated_metric = round($get_food_carbohydrates_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_carbohydrates_calculated_metric = $get_food_carbohydrates_calculated_metric;
						}

						if($get_food_dietary_fiber_metric != ""){
							$inp_food_dietary_fiber_calculated_metric = round($get_food_dietary_fiber_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_dietary_fiber_calculated_metric = $get_food_dietary_fiber_calculated_metric;
						}
	
						if($get_food_carbohydrates_of_which_sugars_metric != ""){
							$inp_food_carbohydrates_of_which_sugars_calculated_metric = round($get_food_carbohydrates_of_which_sugars_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_carbohydrates_of_which_sugars_calculated_metric = $get_food_carbohydrates_of_which_sugars_calculated_metric;
						}
		

						if($get_food_proteins_metric != ""){
							$inp_food_proteins_calculated_metric = round($get_food_proteins_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_proteins_calculated_metric = $get_food_proteins_calculated_metric;
						}

	
	
						if($get_food_salt_metric != ""){
							$inp_food_salt_calculated_metric = round($get_food_salt_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_salt_calculated_metric = $get_food_salt_calculated_metric;
						}

						if($get_food_sodium_metric != ""){
							$inp_food_sodium_calculated_metric = round($get_food_sodium_metric*$inp_food_serving_size_metric/100, 0);
						}
						else{
							$inp_food_sodium_calculated_metric = $get_food_sodium_calculated_metric;
						}
...
WHERE food_id='$get_food_id'") or die(mysqli_error($link));
			...
			<!-- General information -->
				...
				<p><b>$l_net_content ($get_food_net_content_added_measurement):</b><br />
				<input type=\"text\" name=\"inp_food_net_content\" value=\"";
				if($get_food_net_content_added_measurement == "g" OR $get_food_net_content_added_measurement == "ml"){
				...
				<select name=\"inp_food_net_content_measurement\">
					<option value=\"g\""; if($get_food_net_content_added_measurement == "g"){ echo" selected=\"selected\""; } echo">g</option>
					<option value=\"ml\""; if($get_food_net_content_added_measurement == "ml"){ echo" selected=\"selected\""; } echo">ml</option>
					<option value=\"oz_us\""; if($get_food_net_content_added_measurement == "oz_us"){ echo" selected=\"selected\""; } echo">oz (US)</option>
					<option value=\"fl_oz_us\""; if($get_food_net_content_added_measurement == "fl_oz_us"){ echo" selected=\"selected\""; } echo">fl oz (US)</option>
				</select>
				</p>
				...
				<select name=\"inp_food_serving_size_measurement\">
					<option value=\"g\""; if($get_food_serving_size_added_measurement == "g"){ echo" selected=\"selected\""; } echo">g</option>
					<option value=\"ml\""; if($get_food_serving_size_added_measurement == "ml"){ echo" selected=\"selected\""; } echo">ml</option>
					<option value=\"oz_us\""; if($get_food_serving_size_added_measurement == "oz_us"){ echo" selected=\"selected\""; } echo">oz (US)</option>
					<option value=\"fl_oz_us\""; if($get_food_serving_size_added_measurement == "fl_oz_us"){ echo" selected=\"selected\""; } echo">fl oz (US)</option>
				</select><br />

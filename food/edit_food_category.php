			...
			elseif($action == "change_category"){
				...
				if(isset($_GET['inp_food_sub_category_id'])){
					...
					if($get_current_sub_category_id != ""){
						...
						// Pass new values
						$get_food_sub_category_id = $inp_food_sub_category_id;
					}
					else{
						// results
						$ft = "error";
			 ...
			 <tr>
			  ...
			  <td>
				...
				while($row = mysqli_fetch_row($result)) {
					...
					echo"
					<option value=\"edit_food_category.php?action=change_category&amp;food_id=$get_food_id&amp;inp_food_sub_category_id=$get_sub_category_id&amp;l=$l\""; if($get_current_sub_category_id == "$get_sub_category_id"){ echo" selected=\"selected\""; } echo">$get_category_translation_value</option>\n";

		...
		if($get_food_user_id != "$my_user_id"){
			...
			if($action == "edit_language"){
				...
				if(isset($_GET['inp_food_language'])){
					...
					// Pass new values
					$get_food_language = $inp_food_language;
				}
				else{
					$inp_food_language = "";
				}
			...
			elseif($action == "change_category"){
				...
				if(isset($_GET['inp_food_category_id'])){
					$inp_food_category_id = $_GET['inp_food_category_id'];
					$inp_food_category_id = strip_tags(stripslashes($inp_food_category_id));
					$inp_food_category_id_mysql = quote_smart($link, $inp_food_category_id);

					
					$result = mysqli_query($link, "UPDATE $t_food_index SET food_category_id=$inp_food_category_id_mysql WHERE food_id=$food_id_mysql");
					...
					// Pass new values
					$get_food_category_id = $inp_food_category_id;
				}
				else{
					$inp_food_category_id = "";
				}
			}
			...
			<table>
			 ...
			 <tr>
			  ...
			  <td>
				...
				<p>
				<select id=\"inp_c\">
				<option value=\"edit_food_category.php?food_id=$get_food_id&amp;l=$l\">- $l_please_select -</option>
				<option value=\"edit_food_category.php?food_id=$get_food_id&amp;l=$l\"> </option>
				";
				...
				while($row = mysqli_fetch_row($result)) {
					...
					echo"
					<option value=\"edit_food_category.php?food_id=$get_food_id&amp;open_main_category_id=$get_main_category_id&amp;l=$l\""; if($open_main_category_id == "$get_main_category_id"){ echo" selected=\"selected\""; } echo">$get_category_translation_value</option>\n";
			 ...
			 <tr>
			  ...
			  <td>
				...
				<p>
				<select id=\"inp_s\">
				<option value=\"edit_food_category.php?food_id=$get_food_id&amp;l=$l\">- Please select -</option>
				<option value=\"edit_food_category.php?food_id=$get_food_id&amp;l=$l\"> </option>
				...
				while($row = mysqli_fetch_row($result)) {
					...
					echo"
					<option value=\"edit_food_category.php?action=change_category&amp;food_id=$get_food_id&amp;inp_food_category_id=$get_sub_category_id&amp;l=$l\""; if($get_current_sub_category_id == "$get_sub_category_id"){ echo" selected=\"selected\""; } echo">$get_category_translation_value</option>\n";

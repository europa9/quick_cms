...
/**
*
* File: food/new_food_8_images_resize_rotate.php
* Version 1.0.0
	...
	if($get_food_id == ""){
		...
		if($process == "1"){
			...
			if($current_photo_path == ""){
				$url = "new_food_7_images_resize.php?main_category_id=$main_category_id&sub_category_id=$sub_category_id&food_id=$food_id&image_number=$image_number&l=$l&ft=error&fm=image_not_found";
				header("Location: $url");
				exit;
			}
			...
			$url = "new_food_7_images_resize.php?main_category_id=$main_category_id&sub_category_id=$sub_category_id&food_id=$food_id&image_number=$image_number&l=$l&ft=success&fm=image_rotated";
			header("Location: $url");
			exit;

...
/**
*
* File: food/edit_food_numbers_pcs_us.php
* Version 1.0.0
	...
	if(isset($_SESSION['user_id'])){
		...
		if($get_current_food_user_id != "$my_user_id"){
			...
			if($process == 1){
				...
				$url = "edit_food_numbers_pcs_us.php?food_id=$get_current_food_id&l_$l&ft=success&fm=changes_saved";
				header("Location: $url");
				exit;
			...
			<!-- Where am I? -->
				...
				&gt;
				<a href=\"edit_food_numbers_pcs_us.php?food_id=$food_id&amp;l=$l\">$l_numbers</a>
				</p>
			<!-- //Where am I? -->
			...
			<!-- Headline and system -->
				<table>
				 <tr>
				  ...
				  <td>
					<span>
					<a href=\"edit_food_numbers_hundred_metric.php?food_id=$food_id&amp;l=$l\">$l_metric</a>
					&middot;
					<a href=\"edit_food_numbers_pcs_us.php?food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$l_us</a>
					</span>
				  </td>
				 </tr>
				</table>
			...
			<!-- Numbers -->
				<div style=\"float: left;margin-right: 20px;\">
					<form method=\"post\" action=\"edit_food_numbers_pcs_us.php?food_id=$get_current_food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
					 ...
					 <tbody>
					  ...
					  <tr>
					   ...
					   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
						...
						<span class=\"food_saturated_fat\">$get_current_food_monounsaturated_fat_us</span><br />
						<span class=\"food_saturated_fat\">$get_current_food_polyunsaturated_fat_us</span>
						</p>
					  ...
					  <tr>
					   ...
					   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
						<p style=\"margin:0;padding: 0px 0px 4px 0px;\"><span class=\"food_carbohydrates\">$get_current_food_carbohydrates_us</span><br />
						<span class=\"food_carbohydrates_of_which_sugars\">$get_current_food_carbohydrates_of_which_sugars_us</span></p>
					  ...
					  <tr>
					   ...
					   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
						<span class=\"food_dietary_fiber\">$get_current_food_dietary_fiber_us</span>
					   ...
					   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
						<p style=\"margin:0px 0px 4px 0px;padding: 0;\"><input type=\"text\" name=\"inp_food_dietary_fiber_calculated\" value=\"$get_current_food_dietary_fiber_calculated_us\" size=\"3\" /></p>
					   </td>
					  </tr>
					  <tr>
					   <td style=\"padding: 8px 4px 6px 8px;\">
					  ...
					  <tr>
					   ...
					   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
						<span class=\"food_proteins\">$get_current_food_cholesterol_us</span>

...
food_salt_calculated='$inp_food_salt_calculated'
 WHERE food_id='$get_food_id'") or print(mysqli_error());
					...
					$url = "edit_food_numbers.php?food_id=$get_food_id&l_$l&ft=success&fm=changes_saved";
					header("Location: $url");
					exit;
				}
				else{
					$url = "edit_food_numbers.php?food_id=$get_food_id&l=$l";
					$url = $url . "&ft=$ft&fm=$fm";
					header("Location: $url");
					exit;
				}
			...
			<!-- Where am I? -->
				...
				&gt;
				<a href=\"edit_food_numbers.php?food_id=$food_id&amp;l=$l\">$l_numbers</a>
				</p>
			<!-- //Where am I? -->
			...
			<!-- Numbers -->
				<div style=\"float: left;margin-right: 20px;\">
					<form method=\"post\" action=\"edit_food_numbers.php?food_id=$food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
					<h2>$l_numbers</h2>
					...
					<table class=\"hor-zebra\" style=\"width: 350px\">
					 ...
					 <tbody>
					  ...
					  <tr>
		 			  <td style=\"padding: 8px 4px 6px 8px;\">
						<p style=\"margin:0;padding: 0px 0px 4px 0px;\">$l_kcal:</p>

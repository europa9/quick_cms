...
if(isset($_GET['search_query'])) {
	...
	if($search_query != ""){
		...
		$query = $query . "(food_name LIKE $search_query_like_mysql OR food_clean_name LIKE $search_query_clean_mysql OR food_manufacturer_name LIKE $search_query_like_mysql OR food_barcode=$search_query_mysql)";
		// Order
		if($order_by != ""){

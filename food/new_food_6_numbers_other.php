...
food_sodium_calculated='$inp_food_sodium_calculated' WHERE food_id='$get_food_id'") or print(mysqli_error());
				...
				$url = "new_food_6_numbers_other.php?main_category_id=$main_category_id&sub_category_id=$sub_category_id&food_id=$get_food_id&l=$l";
				$url = $url . "&ft=$ft&fm=$fm";
		...
		<!-- General information -->
			...
			<form method=\"post\" action=\"new_food_6_numbers_other.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
			<h2>$l_numbers</h2>

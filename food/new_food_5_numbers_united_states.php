...
WHERE food_id='$get_food_id'") or die(mysqli_error($link));
		...
		<!-- General information -->
			...
			&middot;
			<a href=\"new_food_5_numbers_united_states.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$l_enter_per_pcs</a>
			</p>

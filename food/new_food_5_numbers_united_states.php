...
/**
*
* File: food/new_food_5_united_states.php
* Version 1.0.0
...
WHERE food_id='$get_food_id'") or die(mysqli_error($link));
				...
				$url = "new_food_6_images.php?main_category_id=$main_category_id&sub_category_id=$sub_category_id&food_id=$get_food_id&el=$l";
				header("Location: $url");
				exit;
		}
		...
		<!-- General information -->
			...
			<form method=\"post\" action=\"new_food_5_numbers_united_states.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
			<h2>$l_numbers</h2>

			<p>
			<a href=\"new_food_5_numbers_other.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\">$l_enter_per_hundred</a>
			&middot;
			<a href=\"new_food_5_numbers_united_states.php?main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$l_enter_per $get_food_serving_size_pcs $get_food_serving_size_pcs_measurement</a>
			</p>

	...
	if(isset($_SESSION['user_id'])){
		...
		if($get_food_user_id != "$my_user_id"){
			...
			if($process == 1){
				...
				// Thumb
				if($get_food_thumb_small != "" && file_exists("../$get_food_image_path/$get_food_thumb_small")){
					unlink("../$get_food_image_path/$get_food_thumb_small");
				}
				if($get_food_thumb_medium != "" && file_exists("../$get_food_image_path/$get_food_thumb_medium")){
					unlink("../$get_food_image_path/$get_food_thumb_medium");
				}
				if($get_food_thumb_large != "" && file_exists("../$get_food_image_path/$get_food_thumb_large")){

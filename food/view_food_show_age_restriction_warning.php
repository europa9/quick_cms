...
if($action == ""){
	...
	";
	$x = 0;
	$query = "SELECT restriction_id, restriction_country_iso, restriction_country_name, restriction_country_flag, restriction_language, restriction_age_limit, restriction_title, restriction_text, restriction_can_view_food, restriction_can_view_image FROM $t_food_age_restrictions ORDER BY restriction_country_name ASC";
...
elseif($action == "view_agreement"){
	...
	if($get_restriction_id == ""){
		...
		<p>
		<a href=\"view_food.php?action=agree_to_agreement&amp;main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;food_id=$food_id&amp;country=$get_restriction_country_iso&amp;l=$l\" class=\"btn_default\">$l_agree</a>
		</p>
		";
	}
} // view_agreement

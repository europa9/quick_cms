...
/**
*
* File: talk/open_starred_channel_upload_file_as_attachment.php
* Version 1.0.0
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_current_starred_channel_id == ""){
		...
		if($get_current_channel_id == ""){
			...
			if(!(is_dir("$root/_uploads/talk/attachments/channel_$get_current_channel_id"))){
				mkdir("$root/_uploads/talk/attachments/channel_$get_current_channel_id", 0777);
			}
			...
			if($inp_file_name){	
				if (in_array($extension, $allowed_image_formats)) {
					...
					if($width == "" OR $height == ""){
						...
						$filename = "$root/_uploads/talk/attachments/channel_$get_current_channel_id/". $get_my_user_id . "_" . $datetime_clean . "." . $extension;
						...
						$inp_attachment_path = "_uploads/talk/attachments/channel_$get_current_channel_id";
					...
					$target = "$root/_uploads/talk/attachments/channel_$get_current_channel_id/". $get_my_user_id . "_" . $datetime_clean . "_" . $inp_file_name_clean . "." . $extension;

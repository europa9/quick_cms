...
/**
*
* File: talk/my_starred_channels.php
* Version 1.0.0
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	elseif($action == "delete"){
		...
		if($get_current_starred_channel_id == ""){
			...
			if($process == "1"){
				$result = mysqli_query($link, "DELETE FROM $t_talk_users_starred_channels WHERE starred_channel_id=$get_current_starred_channel_id") or die(mysqli_error($link));

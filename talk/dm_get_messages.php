...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_to_user_id == ""){
		...
		$result = mysqli_query($link, "UPDATE $t_talk_dm_conversations SET conversation_f_unread_messages=0 WHERE conversation_id=$get_current_conversation_id");

	...
	if($action == ""){
		...
		<!-- List all food in all categories -->
			...
			while($row = mysqli_fetch_row($result)) {
				...
				<a href=\"$root/food/view_food.php?food_id=$get_food_id&amp;l=$l\"><img src=\"$thumb\" alt=\"$get_food_thumb\" style=\"margin-bottom: 5px;\" /></a><br />

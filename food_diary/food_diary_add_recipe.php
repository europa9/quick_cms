...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	elseif($action == "add_recipe_to_diary"){
		if($process == 1){
			...
			VALUES 
			(NULL, '$get_my_user_id', $inp_entry_date_mysql, $inp_entry_hour_name_mysql, 0, 
			$inp_entry_recipe_id_mysql, $inp_entry_name_mysql, '', $inp_entry_serving_size_mysql, $inp_entry_serving_size_measurement_mysql, 
			...
			if($get_last_used_id == ""){
				...
				0, 1, '$datetime', $inp_last_used_name_mysql, $inp_last_used_manufacturer, 

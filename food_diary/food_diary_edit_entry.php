		...
		if($process == "1"){
			...
			if($get_current_entry_food_id != "0"){
				...
				if (isset($_POST['inp_submit_gram'])) {
					...
					$inp_entry_food_energy_per_entry = round(($inp_entry_serving_size*$get_food_energy)/100, 1);
					$inp_entry_food_energy_per_entry_mysql = quote_smart($link, $inp_entry_food_energy_per_entry);

					$inp_entry_food_fat_per_entry = round(($inp_entry_serving_size*$get_food_fat)/100, 1);
					$inp_entry_food_fat_per_entry_mysql = quote_smart($link, $inp_entry_food_fat_per_entry);

					$inp_entry_food_carb_per_entry = round(($inp_entry_serving_size*$get_food_carbohydrates)/100, 1);
					$inp_entry_food_carb_per_entry_mysql = quote_smart($link, $inp_entry_food_carb_per_entry);

					$inp_entry_food_protein_per_entry = round(($inp_entry_serving_size*$get_food_proteins)/100, 1);
					...
					$inp_entry_food_energy_per_entry = round(($inp_entry_serving_size*$get_food_energy_calculated)/$get_food_serving_size_pcs, 1);
					$inp_entry_food_energy_per_entry_mysql = quote_smart($link, $inp_entry_food_energy_per_entry);

					$inp_entry_food_fat_per_entry = round(($inp_entry_serving_size*$get_food_fat_calculated)/$get_food_serving_size_pcs, 1);
					$inp_entry_food_fat_per_entry_mysql = quote_smart($link, $inp_entry_food_fat_per_entry);

					$inp_entry_food_carb_per_entry = round(($inp_entry_serving_size*$get_food_carbohydrates_calculated)/$get_food_serving_size_pcs, 1);
					$inp_entry_food_carb_per_entry_mysql = quote_smart($link, $inp_entry_food_carb_per_entry);

					$inp_entry_food_protein_per_entry = round(($inp_entry_serving_size*$get_food_proteins_calculated)/$get_food_serving_size_pcs, 1);
					$inp_entry_food_protein_per_entry_mysql = quote_smart($link, $inp_entry_food_protein_per_entry);

...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($action == ""){
		...
		<!-- Where am I ? -->
			...
			&gt;
			<a href=\"open_group.php?l=$l\">$get_current_group_name</a>
			</p>
		<!-- //Where am I ? -->
		...
		<div class=\"vertical\">
			<ul>
				<li><a href=\"group_members.php?group_id=$get_current_group_id\">$l_group_members</a></li>
				<li><a href=\"group_edit.php?group_id=$get_current_group_id\">$l_edit_group</a></li>
				<li><a href=\"group_delete.php?group_id=$get_current_group_id\">$l_delete_group</a></li>
			</ul>
		</div>
		<!-- //Group actions -->
		";
	...
	Loading...</h1>
	<meta http-equiv=\"refresh\" content=\"1;url=$root/users/login.php?l=$l&amp;referer=$root/rebus/groups.php\">

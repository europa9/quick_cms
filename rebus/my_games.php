	...
	<!-- My games -->
		...
		while($row = mysqli_fetch_row($result)) {
			...
			<div class=\"games_column\">
				<p>
				<a href=\"edit_game.php?game_id=$get_game_id&amp;l=$l\"><img src=\"$root/$get_game_image_path/$get_game_image_thumb_570x321\" alt=\"$get_game_image_thumb_570x321\" /></a><br />
				<a href=\"edit_game.php?game_id=$get_game_id&amp;l=$l\" class=\"h2\">$get_game_title</a><br />
				";

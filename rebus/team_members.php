...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
			...
			if($process == "1"){
				...
				if($get_user_id == ""){
					...
					if(strpos($inp_username_or_email, "@") !== false){
						...
						VALUES 
						(NULL, $inp_email_mysql, $inp_username_mysql, $inp_username_mysql, $inp_password_mysql, $inp_salt_mysql, '$inp_security', $inp_language_mysql, 'metric', $inp_date_format_mysql, '$datetime', '$time', '$datetime', '$time', 'user', '0', 'Newbie', '0', '0', '', '0')")
						...
						$message = $message . "<a href=\"$configSiteURLSav/rebus/team_accept_invitation.php?user_id=$get_user_id&amp;l=$l\">$l_accept</a>";
						$message = $message . "</a>";
	...
	Loading...</h1>
	<meta http-equiv=\"refresh\" content=\"1;url=$root/users/login.php?l=$l&amp;referer=$root/rebus/teams.php\">

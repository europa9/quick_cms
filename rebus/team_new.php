...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
  ...
  "yellow": "#ffff00",
		...
		(member_id, member_team_id, member_status, member_user_id, member_user_name, 
		member_user_email, member_user_photo_destination, member_user_photo_thumb_50, member_joined_datetime, member_joined_date_saying) 
		VALUES 
		(NULL, $get_current_team_id, 'admin', $get_my_user_id, $inp_my_user_name_mysql, 
		$inp_my_user_email_mysql, $inp_my_photo_destination_mysql, $inp_my_photo_thumb_50_mysql, '$datetime', 
		'$date_saying')")
		or die(mysqli_error($link));

		// Open team
		$url = "team_open.php?team_id=$get_current_team_id&l=$l&ft=success&fm=team_created";
		header("Location: $url");
		exit;

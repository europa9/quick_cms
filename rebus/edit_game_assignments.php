		...
		<!-- Assignments -->
			...
			while($row = mysqli_fetch_row($result)) {
				...
				echo"
				 <tr>
				  <td>
					<span><a href=\"edit_game_assignments.php?action=edit_assignment&amp;game_id=$get_current_game_id&amp;assignment_id=$get_assignment_id&amp;l=$l\">$get_assignment_value</a></span>

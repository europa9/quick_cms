...
/**
*
* File: exercise/new_exercise_step_6_muscles_that_are_beeing_trained.php
* Version 1.0.0
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_exercise_id == ""){
					...
					echo"
					  <tr>
					   <td style=\"padding-left: 8px;\">
						<span>
						<a href=\"new_exercise_step_6_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_group_id=$main_group_id&amp;sub_group_id=$sub_group_id&amp;muscle_id=$get_exercise_muscle_muscle_id&amp;l=$l&amp;action=remove\">$get_muscle_translation_simple_name</a>
						</span>
					   </td>
					  </tr>
					";
				...
				while($row = mysqli_fetch_row($result)) {
					...
					echo"	
					 <thead>
					  <tr>
					   <th scope=\"col\">
						<a href=\"new_exercise_step_6_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;l=$l&amp;main_group_id=$get_main_muscle_group_id&amp;l=$l\""; if($main_group_id == "$get_main_muscle_group_id"){ echo" style=\"font-weight: bold;\"";}echo">$get_main_muscle_group_translation_name</a>
					   </th>
					  </tr>
					 </thead>
					 <tbody>
					...
					if($main_group_id == "$get_main_muscle_group_id"){
						...
						while($row_sub = mysqli_fetch_row($result_sub)) {
							...
							echo"
							  <tr>
							   <td style=\"padding-left: 8px;\">
								<a href=\"new_exercise_step_6_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_group_id=$get_main_muscle_group_id&amp;sub_group_id=$get_sub_muscle_group_id&amp;l=$l\""; if($sub_group_id == "$get_sub_muscle_group_id"){ echo" style=\"font-weight: bold;\"";}echo">$get_sub_muscle_group_translation_name</a>
							   </td>
							  </tr>
							";
							...
							if($sub_group_id == "$get_sub_muscle_group_id"){
								...
								while($row_m = mysqli_fetch_row($result_m)) {
									...
									echo"
									<a href=\"new_exercise_step_6_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_group_id=$get_main_muscle_group_id&amp;sub_group_id=$get_sub_muscle_group_id&amp;muscle_id=$get_muscle_id&amp;l=$l&amp;action=add\">$get_muscle_translation_simple_name</a>
									";
								...
								while($row_p = mysqli_fetch_row($result_p)) {
									...
									while($row_m = mysqli_fetch_row($result_m)) {
										...
										echo"
										<a href=\"new_exercise_step_6_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_group_id=$get_main_muscle_group_id&amp;sub_group_id=$get_sub_muscle_group_id&amp;muscle_id=$get_muscle_id&amp;l=$l&amp;action=add\">";
		...
		<div class=\"clear\"></div>
		<p>
		<a href=\"new_exercise_step_7_assistant_muscles.php?exercise_id=$exercise_id&amp;l=$l\" class=\"btn\" />$l_continue</a>
		</p>

					...
					<ul>";
						...
						while($row = mysqli_fetch_row($result)) {
							...
							if($main_category_id == "$get_category_id"){
								...
								// Get sub categories
								$queryb = "SELECT category_id, category_name, category_parent_id FROM $t_diet_categories WHERE category_user_id='0' AND category_parent_id='$get_category_id' ORDER BY category_name ASC";
								...
								while($rowb = mysqli_fetch_row($resultb)) {
									...
									echo"		";
									echo"<li><a href=\"new_meal_plan_step_2_entries_new_entry_food.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;main_category_id=$main_category_id&amp;sub_category_id=$get_sub_category_id&amp;l=$l\""; if($sub_category_id == "$get_sub_category_id"){ echo" style=\"font-weight: bold;\"";}echo">&nbsp; &nbsp; $get_sub_category_translation_value</a></li>\n";
								}
							}

...
/*- Headers ---------------------------------------------------------------------------------- */
$website_title = "$l_workout_diary - $l_my_workout_plans";
if(file_exists("./favicon.ico")){ $root = "."; }
elseif(file_exists("../favicon.ico")){ $root = ".."; }
elseif(file_exists("../../favicon.ico")){ $root = "../.."; }
elseif(file_exists("../../../favicon.ico")){ $root = "../../.."; }
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($action == ""){
		...
		<!-- Quick menu -->
			...
			<p style=\"padding-bottom:0;\">
				<a href=\"$root/workout_diary/my_workout_plans.php?action=browse_workout_plans&amp;l=$l\" class=\"btn_default\">$l_browse_workout_plans</a>
			</p>
	...
	elseif($action == "browse_workout_plans"){
		echo"
		<h1>$l_browse_workout_plans</h1>
		...
		while($row_w = mysqli_fetch_row($result_w)) {
			...
			if($get_workout_weekly_image_file != ""){
				...
				echo"
					...
					<a href=\"my_workout_plans.php?action=select_workout_plan&amp;weekly_id=$get_workout_weekly_id&amp;l=$l&amp;process=1\" class=\"btn_default\">$l_choose</a>
					</p>
				</div>
				";

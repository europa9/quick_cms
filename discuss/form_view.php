...
$query = "SELECT form_id, form_title, form_language, form_introduction, form_insert_title_start, form_tags, form_created, form_updated FROM $t_discuss_forms WHERE form_id=$form_id_mysql";
...
if($get_current_form_id == ""){
	...
	if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
		...
		if($action == "send"){
			...
			$query = "SELECT form_question_id, form_question, form_question_type, form_question_options, form_question_help_text FROM $t_discuss_forms_questions WHERE form_id=$get_current_form_id";
			$result = mysqli_query($link, $query);

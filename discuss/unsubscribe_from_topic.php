...
if($get_current_topic_id == ""){
	...
	$query = "SELECT topic_subscriber_id, topic_id, topic_subscriber_user_id, topic_subscriber_user_email, topic_subscriber_last_sendt_email FROM $t_discuss_topics_subscribers WHERE topic_subscriber_id=$topic_subscriber_id_mysql AND topic_id=$topic_id_mysql";
	$result = mysqli_query($link, $query);
	$row = mysqli_fetch_row($result);
	...
	if($get_current_topic_subscriber_id == ""){
		...
		// Delete unsubscriber
		$result = mysqli_query($link, "DELETE FROM $t_discuss_topics_subscribers WHERE topic_subscriber_id=$get_current_topic_subscriber_id");

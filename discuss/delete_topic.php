	...
	if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
		...
		if(isset($can_edit) && $can_edit == "true"){
			if($process == "1"){
				...
				$result = mysqli_query($link, "DELETE FROM $t_discuss_topics WHERE topic_id=$topic_id_mysql");
				$result = mysqli_query($link, "DELETE FROM $t_discuss_replies WHERE reply_topic_id=$topic_id_mysql");

	...
	if($action == ""){
		...
		<!-- You are here -->
			<div class=\"you_are_here\">
				...
				&gt; 
				<a href=\"photo.php?l=$l\">$l_photo</a>
				</p>
			</div>
		<!-- //You are here -->
		...
		<!-- Form -->
			...
			<!-- //Focus -->
			<form method=\"POST\" action=\"photo_upload.php?action=upload&amp;l=$l&amp;process=1\" id=\"upload_cover_photo_form\" enctype=\"multipart/form-data\">
				...
				if(file_exists("$root/_uploads/users/images/$get_photo_user_id/$get_photo_destination")){
					...
					<div class=\"responsive\">
						<div class=\"gallery\">
							...
							<a href=\"photo_edit.php?photo_id=$get_photo_id&amp;l=$l\"><img src=\"$root/_uploads/users/images/$get_photo_user_id/$get_photo_thumb_200\" alt=\"$get_photo_destination\" class=\"photo_img\" /></a>
							<div class=\"desc\">
								<span>$get_photo_title<br />
								<a href=\"photo_rotate.php?photo_id=$get_photo_id&amp;rotate=90&amp;process=1&amp;l=$l\" class=\"btn\">$l_rotate</a>
								</span>
							</div>
						</div>
					</div>

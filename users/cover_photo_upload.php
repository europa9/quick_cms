...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
		...
		if($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			if($image){
				...
				if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) {
					...
					$url = "index.php?category=users&page=cover_photo&l=$l&ft=$ft&fm=$fm"; 
					header("Location: $url");
					exit;
				}
				else{
					...
					if($width == "" OR $height == ""){
						...
						$ft = "success";
						$fm = "photo_uploaded";
						$url = "cover_photo.php?l=$l&ft=$ft&fm=$fm"; 
						header("Location: $url");
						exit;
	...
	if($action == ""){
		...
		<form method=\"POST\" action=\"cover_photo_upload.php?action=upload&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\" name=\"nameform\">
		...
		<!-- Go back -->
			<p><br />
			<a href=\"cover_photo.php?l=$l\"><img src=\"$root/_webdesign/images/icons/16x16/go-previous.png\" alt=\"go-previous.png\" /></a>

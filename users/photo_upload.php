	...
	if($action == ""){
		...
		<!-- You are here -->
			<div class=\"you_are_here\">
				...
				&gt; 
				<a href=\"photo_upload.php?l=$l\">$l_upload_photo</a>
				</p>
			</div>
		<!-- //You are here -->


		<form method=\"POST\" action=\"photo_upload.php?action=upload&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">

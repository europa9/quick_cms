...
/*- Headers ---------------------------------------------------------------------------------- */
$website_title = "$l_users - $l_known_devices";
if(file_exists("./favicon.ico")){ $root = "."; }
elseif(file_exists("../favicon.ico")){ $root = ".."; }
elseif(file_exists("../../favicon.ico")){ $root = "../.."; }
elseif(file_exists("../../../favicon.ico")){ $root = "../../.."; }
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($action == ""){
		...
		<!-- You are here -->
			<div class=\"you_are_here\">
				...
				&gt; 
				<a href=\"known_devices.php?l=$l\">$l_known_devices</a>
				</p>
			</div>
		<!-- //You are here -->
			...
			while($row = mysqli_fetch_row($result)) {
				...
				echo"
				 <tr>
				  ...
				  <td>
					<p>
					<a href=\"known_devices.php?action=report&amp;known_device_id=$get_known_device_id\"><img src=\"_gfx/report.png\" alt=\"report.png\" /></a>
					<a href=\"known_devices.php?action=delete&amp;known_device_id=$get_known_device_id&amp;process=1\"><img src=\"_gfx/delete.png\" alt=\"delete.png\" /></a>
					</p>
				  </td>
				 </tr>
				";
	...
	elseif($action == "report"){
		...
		if($get_current_known_device_id == ""){
			...
			if($process == "1"){
				...
				// Header
				$url = "known_devices.php?known_device_id=$get_current_known_device_id&l=$l&ft=success&fm=report_sent";
				header("Location: $url");
				exit;
			...
			<!-- You are here -->
				...
				<a href=\"known_devices.php?l=$l\">$l_known_devices</a>
				&gt; 
				<a href=\"known_devices.php?action=report&amp;known_device_id=$get_current_known_device_id&amp;l=$l\">$l_report</a>
				</p>
			<!-- //You are here -->
			...
			<!-- Report content -->
				...
				<p>
				<a href=\"known_devices.php?action=report&amp;known_device_id=$get_current_known_device_id&amp;process=1&amp;l=$l\" class=\"btn_default\">$l_send_report</a>
				<a href=\"known_devices.php?l=$l#known_device_id$get_current_known_device_id\" class=\"btn_default\">$l_cancel</a>	
				</p>
			<!-- //Report content -->
			";
		} // device found
	...
	elseif($action == "delete"){
		...
		if($get_current_known_device_id == ""){
			...
			// Header
			$url = "known_devices.php?known_device_id=$get_current_known_device_id&l=$l&ft=success&fm=known_login_deleted";
			header("Location: $url");
			exit;

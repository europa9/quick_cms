	...
	if($q != ""){
		...
		while($row = mysqli_fetch_row($result)) {
			...
			if($get_food_image_a != "" && file_exists("../$get_food_image_path/$get_food_image_a")){
				...
				<a href=\"../food/view_food.php?food_id=$get_food_id&amp;l=$l\" class=\"_blank\"><img src=\"../$get_food_image_path/$get_food_thumb_small\" alt=\"$get_food_image_a\" style=\"margin-bottom: 5px;\" /></a><br />
				<a href=\"../food/view_food.php?food_id=$get_food_id&amp;l=$l\" class=\"_blank\">$title</a>
				</p>

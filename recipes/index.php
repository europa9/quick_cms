		...
		while($row = mysqli_fetch_row($result)) {
			...
			if($get_recipe_image != ""){
				...
				if($get_recipe_thumb_278x156 == "" OR !(file_exists("$root/$get_recipe_image_path/$get_recipe_thumb_278x184"))){
					...
					echo"<div class=\"info\"><p>Creating recipe thumb $inp_new_x x $inp_new_y px of <a href=\"$root/$get_recipe_image_path/$get_recipe_image\">$root/$get_recipe_image_path/$get_recipe_image</a></p></div>";
